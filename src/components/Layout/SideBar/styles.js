...
export const SocialMediasList = styled.div`
  ...
  background: ${(props) =>
    props.light
      ? "linear-gradient(0deg, rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.2)), #40BA93;"
      : "linear-gradient(0deg, rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.2)), radial-gradient(60.68% 60.68% at 50.88% 47.73%, #265041 0%, #222121 100%)"};
  transform: translateX(-50%);

  border: ${(props) =>
    props.light ? "0.052vw solid #BDBDBD" : "0.052vw solid #4F4F4F"};
  border-radius: 0.8vw;
  font-size: 1vw;
...
export const LinkList = styled.ul`
  ...
  border: ${(props) =>
    props.light ? "0.052vw solid #E0E0E0" : "0.052vw solid #4F4F4F"};
  border-radius: 1vw;
  ...
  .link-message-item {
    border: ${(props) =>
      props.light ? "1px solid #E0E0E0" : "1px solid #4F4F4F"};
    margin-top: 4vw;
